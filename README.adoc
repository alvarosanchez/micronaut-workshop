...
== Getting started with Micronaut and GraalVM (15 minutes)
...
=== Using Micronaut Launch to create a new application (2 minutes)

icon:hand-o-right[] We will use the third option, so that you can copy/paste the command. To see the options available,
run:
...
You can now unzip the file and open it in your IDE.

=== Running the application with the Micronaut Maven Plugin (2 minutes)
...
=== Creating a Hello World controller (2 minutes)
